...
function roundToPowerOfTen(num, pow) {
    ...
    let roundedNum = (Math.round((Number(strNumber.slice((pow+1) * (-1)))) / Math.pow(10, pow)) * Math.pow(10, pow)).toString();
    return Number(strNumber.replace(strNumber.slice((pow+1) * (-1)), roundedNum));
}
